...
//	THUMBNAIL, ISBN, ,TITLE, CONTENTS, AUTHORS, PUBLISHER, PUB_YEAR, PRICE, KEYWORD, CLASS_MAJOR, CLASS_MINOR, CRE_DT, CRE_ID, MOD_DT, MOD_ID, USE_YN, STOCK
	...
	void productUpdate(String thumbnail, String isbn, String authors, String publisher, String pub_year, String price, String title, String contents, String stock);
