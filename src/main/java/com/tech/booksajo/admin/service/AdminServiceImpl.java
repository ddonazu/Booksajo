...
//	}
	...
	@Override
	public void productUpdate(String thumbnail, String isbn, String authors, String publisher, String pub_year, String price, String title, String contents, String stock) {
		mapper.productUpdate(thumbnail, isbn, authors, publisher, pub_year, price, title, contents, stock);
