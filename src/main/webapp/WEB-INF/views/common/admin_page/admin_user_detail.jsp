	...
	<div class="contents_area">
		<div class="content_area">
			...
			<table style="text-align: center">
				<tr>
					<th colspan="3" style="font-size: 18px; font-weight: bold;">주문내역</th>
				</tr>
				<tr>
					<th>주문 날짜</th>
					<th>주문 번호</th>
				...
				<c:forEach items="${orderList }" var="orderList">
					<tr class="order_list" onclick="select(${orderList.order_no })">
						<td>
							<span style="padding: 0px;">${orderList.order_date }</span>
						</td>
						<td>
							<span style="padding: 0px;">${orderList.order_no }</span>
						</td>
						<td>
							<span style="padding: 0px;">${orderList.total_price }원</span>
						</td>
					</tr>
				</c:forEach>
			</table>
