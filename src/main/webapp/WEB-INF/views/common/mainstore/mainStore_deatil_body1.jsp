...
<hr align="center" style="border: 4px; width: 90%; height: 100%;">
	...
	<div id="map" style="width: 950px; height: 420px; left: 25%;">
		<script type="text/javascript"
			src="//dapi.kakao.com/v2/maps/sdk.js?appkey=92b17a1330650b99d134f417d561252d"></script>
		<script>
			var mapContainer = document.getElementById('map'), mapOption = {
				center : new kakao.maps.LatLng(37.570942, 126.977763),
				level : 2
			};
			...
			iwPosition = new kakao.maps.LatLng(37.570942, 126.977763), iwRemoveable = true;
