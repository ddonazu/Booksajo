...
<body>	
	...
	<div class="nav">
				<ul>
					<li><a href="http://localhost:9007/booksajo/mainStore2">위치안내</a></li>
					<li><a href="#">주차안내</a></li>
...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
        center: new kakao.maps.LatLng(37.517125, 126.903795), // 지도 중심좌표
        level: 2 // 지도의 확대 레벨
    };
...
var infowindow = new kakao.maps.InfoWindow({
	...
	<div class="address" id="skip_map">
		<p id="address">
			<img src="http://image.kyobobook.co.kr/ink/images/storeinfo/2020_renew/icon_map.png" alt="주소">서울특별시 영등포구 영중로 15, 타임스퀘어 멀티플렉스 2층
		</p>
	</div>
</body>
