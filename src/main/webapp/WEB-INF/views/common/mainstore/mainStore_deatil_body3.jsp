...
var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
    mapOption = { 
        center: new kakao.maps.LatLng(37.503696, 127.024154), // 지도 중심좌표
        level: 2 // 지도의 확대 레벨
    };

var map = new kakao.maps.Map(mapContainer, mapOption); // 지도생성

var iwContent = '<div style="padding:5px; font-style: 17px !important;margin: -3px 0px 0px 14px;">책사조 강남점</div>', 
				// 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능
    iwPosition = new kakao.maps.LatLng(37.503696, 127.024154), //인포윈도우 표시 위치입니다
...
var infowindow = new kakao.maps.InfoWindow({
	...
	<div class="address" id="skip_map">
		<p id="address">
			<img src="http://image.kyobobook.co.kr/ink/images/storeinfo/2020_renew/icon_map.png" alt="주소">서울특별시 서초구 강남대로 465, 교보타워 지하 1~지하 2층
		</p>
	</div>
</body>
