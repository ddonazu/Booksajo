...
<link rel="stylesheet" type="text/css" href="resources/lib/bootstrap/css/bootstrap.min.css">
  ...
  <li class="nav-item">
    <a class="nav-link" style="font-size: small; text-align: left;" href="faqlist">·FAQ</a>
  </li>

  <li class="nav-item">
    <a class="nav-link" style="font-size: small;  text-align: left;" href="http://localhost:9007/booksajo/mainStore1">·매장안내</a>
  </li>
