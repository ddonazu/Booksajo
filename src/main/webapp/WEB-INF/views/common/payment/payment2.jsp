...
<div id="conte">
	...
	<div id="custominfo">
		<table style="width: 100%; margin-bottom: 70px; text-align: left;">
			<tr>
				...
				<td width="150px">이름 ${payinfo.user_name }</td>
				<td width="180px">전화번호 ${payinfo.user_phone }</td>
	...
	<button id="btn-kakaopay" class="btn btn-primary" onclick="kakaopay();" value="카카오페이 " />
...
<div id="div2">
	...
	<div id="totalpayment">
		...
		<input type="button" id="but" value="결제하기" class="btn_blue2"/> <input type="button"
			value="장바구니가기" />
	</div>
