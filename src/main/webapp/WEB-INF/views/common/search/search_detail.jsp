							...
							$
									...
									.done(
											function(data) { //들어올때도 어쨋든 제이슨타입으로 1개 들어오는거니까 인덱스 써줘야함 틀린이유.
												...
												html += '</tr>';
												html += '<tr>';
												html += '<td colspan="3" id="x" style="height:50px; font-size:large; text-align: left;">'
														+ contentcut[0];
												+'</td>';
												html += '</tr>';
												html += '</br><tr>';
												html += '<td colspan="3" id="au" style="font-size:medium;" ></br>'
	...
	<span class="btn_count">
		...
		<button type="button"
			...
			<img src="resources/img/btn_minus.gif" alt="수량 빼기">
				...
				<input type="submit" value="바로구매" id="payment" class="btn_blue2" onclick="location.href='payment?isbn=${isbn}'" /> 
		...
		<tbody>
			<tr>
				<th><img
					...
					alt="품질인증마크" width="20" height="30" vspace="5" hspace="29">
					<br>
					제품안전인증</th>
